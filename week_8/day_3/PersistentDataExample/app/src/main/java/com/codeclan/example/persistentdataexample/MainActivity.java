...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String previousSavedText = SavedTextPreferences.getStoredText(MainActivity.this);
        if (previousSavedText != null && !previousSavedText.isEmpty()){
            textToSave.setVisibility(View.INVISIBLE);
            saveButton.setVisibility(View.INVISIBLE);
            savedText.setText(previousSavedText);
    ...
    public void onSaveButtonClick(View view) {
        ...
        SavedTextPreferences.setStoredText(MainActivity.this, stringToSave);
    }
