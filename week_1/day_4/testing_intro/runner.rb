...
#can use this file to use all the functions to test the function suite to see if they're all working. But it's not great because it would be impossible if we had thousands of functions.
